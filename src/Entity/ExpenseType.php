...
#[ApiResource(
    ...
    operations: [
        new Get('/expense-types/{id}', input: ExpenseType::class),
        new GetCollection('/expense-types', input: ExpenseType::class),
        new Post('/expense-types', input: ExpenseType::class),
        new Patch('/expense-types/{id}', input: ExpenseType::class),
    ],
